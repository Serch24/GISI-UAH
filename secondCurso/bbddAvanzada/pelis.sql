-- Eliminar tablas y restricciones si existen
DROP TABLE IF EXISTS peliculas.visualizaciones;
DROP TABLE IF EXISTS peliculas.criticas;
DROP TABLE IF EXISTS peliculas.generos;
DROP TABLE IF EXISTS peliculas.actua;
DROP TABLE IF EXISTS peliculas.peliculas;
DROP TABLE IF EXISTS peliculas.personas;
...
CREATE TABLE peliculas.actua (
	...
	CONSTRAINT actua_pk PRIMARY KEY (codigo_pelicula_peliculas,codigo_personas_personas)
);
-- ddl-end --
...
CREATE TABLE peliculas.visualizaciones (
	...
	codigo_personas_personas numeric NOT NULL,
	codigo_pelicula_peliculas numeric NOT NULL,
	CONSTRAINT visualizaciones_pk PRIMARY KEY (codigo_personas_personas,codigo_pelicula_peliculas)
);
-- ddl-end --
